...
with st.expander("📖 사용 방법"):
    st.write("1️⃣ 왼쪽에 최근 10회차 당첨번호를 입력합니다.")
    st.write("2️⃣ [분석 시작] 버튼을 클릭합니다.")
    st.write("3️⃣ 오른쪽에서 번호 빈도 분석 결과를 확인합니다.")
    st.write("4️⃣ [조합 생성] 버튼을 클릭합니다.")
    st.write("5️⃣ 황금비율 기반 추천 조합을 확인합니다.")
    st.write("6️⃣ 분석 기준 회차")
    st.write("   • 과거 10회귀 데이터 : 1199회 ~ 1190회")
    st.write("   • 최근 10회차 데이터 : 1208회 ~ 1199회")
